...
import { ArbitrageProvider } from "./contexts/arbitrage-context";
...
const AuthContext = createContext<{
  ...
  setIsPageRefresh: (value: boolean) => void;
}>({
...
export function useCustomNavigation() {
  ...
  const navigateTo = (path: string) => {
    if (isAuthenticated && (path === "/" || (path === "/dashboard" && location.pathname === "/dashboard"))) {
      navigate("/dashboard");
    } else {
      navigate(path);
    }
...
// Modify any component that uses navigation to use this custom hook
// This will be available throughout your application
